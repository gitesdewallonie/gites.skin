...
class HebergementInfo(BrowserView):
    ...
    def updateHebergementMaj(self):
        ...
        fields = self.request
        chargeFk = fields.get('heb_maj_charge_fk')
        hebMajHebPk = fields.get('heb_maj_hebpk')
        hebNom = fields.get('heb_maj_nom')
        ...
        record.heb_maj_tenis = fields.get('heb_maj_tenis')
        record.heb_maj_nautisme = fields.get('heb_maj_nautisme')
        record.heb_maj_sky = fields.get('heb_maj_sky')
        record.heb_maj_rando = fields.get('heb_maj_rando')
        record.heb_maj_piscine = fields.get('heb_maj_piscine')
        record.heb_maj_peche = fields.get('heb_maj_peche')
        record.heb_maj_equitation = fields.get('heb_maj_equitation')
        record.heb_maj_velo = fields.get('heb_maj_velo')
        record.heb_maj_vtt = fields.get('heb_maj_vtt')
        record.heb_maj_ravel = fields.get('heb_maj_ravel')
        record.heb_maj_animal = fields.get('heb_maj_animal')
        record.heb_maj_fumeur = fields.get('heb_maj_fumeur')
        record.heb_maj_tenis_distance = fields.get('heb_maj_tenis_distance')
        record.heb_maj_nautisme_distance = fields.get('heb_maj_nautisme_distance')
        record.heb_maj_sky_distance = fields.get('heb_maj_sky_distance')
        record.heb_maj_rando_distance = fields.get('heb_maj_rando_distance')
        record.heb_maj_piscine_distance = fields.get('heb_maj_piscine_distance')
        record.heb_maj_peche_distance = fields.get('heb_maj_peche_distance')
        record.heb_maj_equitation_distance = fields.get('heb_maj_equitation_distance')
        record.heb_maj_velo_distance = fields.get('heb_maj_velo_distance')
        record.heb_maj_vtt_distance = fields.get('heb_maj_vtt_distance')
        record.heb_maj_ravel_distance = fields.get('heb_maj_ravel_distance')
        record.heb_maj_confort_tv = fields.get('heb_maj_confort_tv')
        record.heb_maj_confort_feu_ouvert = fields.get('heb_maj_confort_feu_ouvert')
        record.heb_maj_confort_lave_vaiselle = fields.get('heb_maj_confort_lave_vaiselle')
        record.heb_maj_confort_micro_onde = fields.get('heb_maj_confort_micro_onde')
        record.heb_maj_confort_lave_linge = fields.get('heb_maj_confort_lave_linge')
        record.heb_maj_confort_seche_linge = fields.get('heb_maj_confort_seche_linge')
        record.heb_maj_confort_congelateur = fields.get('heb_maj_confort_congelateur')
        record.heb_maj_confort_internet = fields.get('heb_maj_confort_internet')
        record.heb_maj_commerce = fields.get('heb_maj_commerce')
        record.heb_maj_commerce_distance = fields.get('heb_maj_commerce_distance')
        record.heb_maj_restaurant = fields.get('heb_maj_restaurant')
        record.heb_maj_restaurant_distance = fields.get('heb_maj_restaurant_distance')
        record.heb_maj_gare = fields.get('heb_maj_gare')
        record.heb_maj_gare_distance = fields.get('heb_maj_gare_distance')
        record.heb_maj_taxe_sejour = fields.get('heb_maj_taxe_sejour')
        record.heb_maj_taxe_montant = fields.get('heb_maj_taxe_montant')
        record.heb_maj_forfait_montant = fields.get('heb_maj_forfait_montant')
        record.heb_maj_tarif_we_3n = fields.get('heb_maj_tarif_we_3n')
        record.heb_maj_tarif_we_4n = fields.get('heb_maj_tarif_we_4n')
        record.heb_maj_tarif_semaine_fin_annee = fields.get('heb_maj_tarif_semaine_fin_annee')
        record.heb_maj_tarif_we_bs = fields.get('heb_maj_tarif_we_bs')
        record.heb_maj_tarif_we_ms = fields.get('heb_maj_tarif_we_ms')
        record.heb_maj_tarif_we_hs = fields.get('heb_maj_tarif_we_hs')
        record.heb_maj_tarif_sem_bs = fields.get('heb_maj_tarif_sem_bs')
        record.heb_maj_tarif_sem_ms = fields.get('heb_maj_tarif_sem_ms')
        record.heb_maj_tarif_sem_hs = fields.get('heb_maj_tarif_sem_hs')
        record.heb_maj_tarif_garantie = fields.get('heb_maj_tarif_garantie')
        record.heb_maj_tarif_divers = unicode(fields.get('heb_maj_tarif_divers'), 'utf-8')
        record.heb_maj_tarif_chmbr_avec_dej_1p = fields.get('heb_maj_tarif_chmbr_avec_dej_1p')
        record.heb_maj_tarif_chmbr_avec_dej_2p = fields.get('heb_maj_tarif_chmbr_avec_dej_2p')
        record.heb_maj_tarif_chmbr_avec_dej_3p = fields.get('heb_maj_tarif_chmbr_avec_dej_3p')
        record.heb_maj_tarif_chmbr_sans_dej_1p = fields.get('heb_maj_tarif_chmbr_sans_dej_1p')
        record.heb_maj_tarif_chmbr_sans_dej_2p = fields.get('heb_maj_tarif_chmbr_sans_dej_2p')
        record.heb_maj_tarif_chmbr_sans_dej_3p = fields.get('heb_maj_tarif_chmbr_sans_dej_3p')
        record.heb_maj_tarif_chmbr_table_hote_1p = fields.get('heb_maj_tarif_chmbr_table_hote_1p')
        record.heb_maj_tarif_chmbr_table_hote_2p = fields.get('heb_maj_tarif_chmbr_table_hote_2p')
        record.heb_maj_tarif_chmbr_table_hote_3p = fields.get('heb_maj_tarif_chmbr_table_hote_3p')
        record.heb_maj_tarif_chmbr_autre_1p = fields.get('heb_maj_tarif_chmbr_autre_1p')
        record.heb_maj_tarif_chmbr_autre_2p = fields.get('heb_maj_tarif_chmbr_autre_2p')
        record.heb_maj_tarif_chmbr_autre_3p = fields.get('heb_maj_tarif_chmbr_autre_3p')
        record.heb_maj_lit_1p = fields.get('heb_maj_lit_1p')
        record.heb_maj_lit_2p = fields.get('heb_maj_lit_2p')
        record.heb_maj_lit_sup = fields.get('heb_maj_lit_sup')
        record.heb_maj_lit_enf = fields.get('heb_maj_lit_enf')
        ...
        record.heb_maj_distribution_fr = fields.get('heb_maj_distribution_fr')
